...
class Organization extends LitElement {
  render() {
    return html`
      <div>
        <h1>Organization</h1>
        <a href="/organization/param">OParam</a>
      </div>
    `;
  }
}

class OrganizationParam extends LitElement {
  render() {
    return html`
      <div>
        <h1>OrganizationParam</h1>
      </div>
    `;
  }
}
...
customElements.define('my-organization-param', OrganizationParam);
